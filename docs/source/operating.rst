...
Generated On: 2024-11-19 18:19:04 UTC
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/167594225-myseneca/cyt160-raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=34655  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='167594225-myseneca'  \-\-env DOCKERUSERNAME='xXjona18Xx'  \-\-env MQTTUSERNAME='xXjonaXx'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   docker run -d -p 56047:56047 -p 59901:59901 -p 41587:41587 \-\-env TSS=0 \-\-env SOLUTIONNAME=cyt160proj02-4a57 \-\-env SOLUTIONDAG=solution_preprocessing_dag-cyt160proj02-4a57 \-\-env GITUSERNAME=167594225-myseneca  \-\-env GITREPOURL=https://github.com/167594225-myseneca/cyt160-raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=56047  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=59901  \-\-env SOLUTIONVIPERVIZPORT=41587 \-\-env DOCKERUSERNAME='xXjona18Xx'  \-\-env EXTERNALPORT=34655 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='xXjonaXx' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  xXjona18Xx/cyt160proj02-4a57-amd64
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=56047, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37149, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=34067, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=41141, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=40257, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=43683, HPDEHOST=127.0.1.1, HPDEPORT=36167, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41301

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3707-cyt160proj02-4a57,solution_preprocessing_dag-cyt160proj02-4a57, python-preprocess-9565-cyt160proj02-4a57,solution_preprocessing_dag-cyt160proj02-4a57, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
