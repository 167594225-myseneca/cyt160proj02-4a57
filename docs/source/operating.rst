[cyt160proj02-4a57] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cyt160proj02-4a57] container is NOT running**.

.. tip::
   You must have your [cyt160proj02-4a57] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/167594225-myseneca/cyt160-raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=38595  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='167594225-myseneca'  \-\-env DOCKERUSERNAME='xXjona18Xx'  \-\-env MQTTUSERNAME='xXjonaXx'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   xXjona18Xx/cyt160proj02-4a57-amd64 (https://hub.docker.com/r/xXjona18Xx/cyt160proj02-4a57-amd64)
...
.. code-block::
   ...
   docker run -d -p 34237:34237 -p 33863:33863 -p 40115:40115 \-\-env TSS=0 \-\-env SOLUTIONNAME=cyt160proj02-4a57 \-\-env SOLUTIONDAG=solution_preprocessing_dag-cyt160proj02-4a57 \-\-env GITUSERNAME=167594225-myseneca  \-\-env GITREPOURL=https://github.com/167594225-myseneca/cyt160-raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=34237  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=33863  \-\-env SOLUTIONVIPERVIZPORT=40115 \-\-env DOCKERUSERNAME='xXjona18Xx'  \-\-env EXTERNALPORT=38595 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='xXjonaXx' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  xXjona18Xx/cyt160proj02-4a57-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - xXjona18Xx/cyt160proj02-4a57-amd64
...
[cyt160proj02-4a57] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/167594225-myseneca/cyt160-raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cyt160proj02-4a57
...
.. important::
   https://cyt160proj02-4a57.readthedocs.io
...
.. important::
   solution_preprocessing_dag-cyt160proj02-4a57
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=34237, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37921, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41399, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34631, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36595, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41729, HPDEHOST=127.0.1.1, HPDEPORT=39267, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=32817

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6766-cyt160proj02-4a57,solution_preprocessing_dag-cyt160proj02-4a57, python-preprocess-7172-cyt160proj02-4a57,solution_preprocessing_dag-cyt160proj02-4a57, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
